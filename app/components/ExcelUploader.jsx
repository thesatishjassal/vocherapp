...
const ExcelUploaderModal = ({ show, onClose }) => {
  ...
  const handleFileChange = (e) => {
    ...
    if (selectedFile && (selectedFile.name.endsWith('.xlsx') || selectedFile.name.endsWith('.xls'))) {
      ...
      toast.error('Invalid file type. Please upload a valid Excel file (.xlsx, .xls)');
      setFile(null);
    }
  };
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      toast.error(error.response?.data?.detail || 'File upload failed. Please try again.');
    } finally {
      setLoading(false);
    }
  };
                ...
                >
                  {file ? (
                    ...
                    <>
                      ...
                      <span className="text-muted">Click to select Excel file (.xlsx, .xls)</span>
                    </>
                  )}
                  <input
                    id="fileUpload"
